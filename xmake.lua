...
target("RnTools")
    ...
    on_load(function (target)
        local ResourceDir = path.join(GeneratedDir, "ImguiRn/Resources")
        ...
        os.cp(path.join(ProjectDir, "assets/ImguiRn/Fonts/fa-solid-900.ttf"), SolidBin)
        os.cp(path.join(ProjectDir, "assets/ImguiRn/Fonts/fa-brands-400.ttf"), BrandsBin)
